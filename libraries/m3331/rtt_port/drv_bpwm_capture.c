...
//              rt_kprintf("[%s.%d] %d \n", psNuBpwmCap->name, psNuBpwmCap->u8Channel, psNuBpwmCap->modid );
//              rt_kprintf("[%s.%d] %d \n", psNuBpwmCap->name, psNuBpwmCap->u8Channel, psNuBpwmCap->rstidx );
//              rt_kprintf("[%s.%d] %d \n", psNuBpwmCap->name, psNuBpwmCap->u8Channel, psNuBpwmCap->irqn );
