...
#define SAU_INIT_REGION(n) \
    ...
    If user wants to use TrurstZone, they should have their nu_partition_m3331.h.
    For TrustZone projects, path of local nu_partition_m3331.h should be in the
    front of the include path list to make sure local nu_partition_m3331.h is used.

    It also apply to non-secure project of the TrustZone projects.

    */
    #error "Link to default nu_partition_m3331.h in secure mode. Please check your include path."
#endif
