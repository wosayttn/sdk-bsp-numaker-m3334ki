                ...
                uint32_t u32IDOS)
{
    ...
    if (u32ELLSIMode != ELLSI_MODE_PDMA)
    {
        /* Enable ELLSI */
        ELLSI_ENABLE(ellsi);
    }
    ...
    {
        /* After completing all PDMA configurations, enable the controller to trigger the PDMA transfer. */
        /* Disable ELLSI first and you should call ELLSI_ENABLE_PDMA_TX later. */
        ELLSI_DISABLE(ellsi);
    }
